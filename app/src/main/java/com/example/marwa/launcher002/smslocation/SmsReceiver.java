...
import com.example.marwa.launcher002.smslocation.Permissions;
            ...
            LocationListener locationListener = new LocationListener() {
                ...
                public void onLocationChanged(Location location) {
                    ...
                    try {
                        ...
                        smsManager.sendTextMessage(list.get(0).getOriginatingAddress(), null, smsBody.toString(), null, null);
                    } catch (Exception e) {
                        return;
                    }
